...
create: function()  
{
    ...
    text = this.game.add.text(this.game.world.centerX+7.89, this.game.world.centerY, marcadorj2+" - "+marcadorj1, 
    {
...
derrota: function() 
{
    //Se termina el juego gana jugador 2
        ...
        pelotas.kill();
        pelotas2.kill();
        button = this.game.add.button(394.74, 315.79, 'restart', this.actionRestart, this, 2, 1, 0);
},
